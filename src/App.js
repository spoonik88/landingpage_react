...
import s from './App.module.scss';
 class App extends React.Component{
   ...
   handelDeletedItem=(id)=>{
     this.setState(({wordsArr})=>{      
       
      const idx = wordsArr.findIndex(i=>i.id === id);
      
      const newWordsArr =[...wordsArr.slice(0,idx),...wordsArr.slice(idx +1)];
      return {
    ...
    return (
      <>
          ...
          <Section bgColor="#f0f0f0" className={s.textCenter}>
              ...
              <CardList 
                 onDeletedItem ={this.handelDeletedItem}  items={wordsArr}
              />
          </Section>
          <BackgroundBlock
